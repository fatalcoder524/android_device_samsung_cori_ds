...
TARGET_BOOTLOADER_BOARD_NAME 			:= cori_ds
...
TARGET_RECOVERY_FSTAB				:= device/samsung/cori_ds/recovery/recovery.fstab

# Prebuilt kernel NOTE: Delete from package
TARGET_PREBUILT_KERNEL		                := device/samsung/cori_ds/prebuilt/kernel
##TARGET_KERNEL_SOURCE                          := kernel/samsung/cori_ds
##TARGET_KERNEL_CONFIG                          := cyanogenmod_cori_ds_defconfig
